    ...
    .allOrder{
        ...
        div{
            ...
            .allDiv{
                ...
                p{position:relative;padding:10px 20px;display:flex;flex-direction:column;span{font-size:32px;}i.num{display:block;height:80px;width:80px;background:#FD5200;color:#fff;position:absolute;top:20px;right:-220px;border-radius:50%;text-align:center;line-height:80px;font-style:normal;font-weight:bold;}}
            }
